...
namespace XOutputRedux.HidSharper.Reports.Input
{
    ...
    public class DeviceItemInputParser
    {
        ...
        /// <param name="report"><see cref="HidSharper.Reports.Report"/> the buffer conforms to.</param>
        ...
        /// <summary>
        /// The number of unique values in the <see cref="HidSharper.Reports.DeviceItem"/>.
        /// </summary>
