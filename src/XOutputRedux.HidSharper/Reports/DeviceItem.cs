...
namespace XOutputRedux.HidSharper.Reports
{
    public class DeviceItem : DescriptorCollectionItem
    {
        ...
        /// <summary>
        /// Creates a <see cref="HidSharper.Reports.Input.DeviceItemInputParser"/> appropriate for parsing reports for this device item.
        /// </summary>
        /// <returns>The new <see cref="HidSharper.Reports.Input.DeviceItemInputParser"/>.</returns>
        /// <remarks>
        /// Pair this with a <see cref="HidSharper.Reports.Input.HidDeviceInputReceiver"/> for the <see cref="ReportDescriptor"/>.
        /// </remarks>
