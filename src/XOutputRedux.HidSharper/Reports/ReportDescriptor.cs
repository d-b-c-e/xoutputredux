...
using System.Linq;
using XOutputRedux.HidSharper.Reports.Encodings;

namespace XOutputRedux.HidSharper.Reports
{
    /// <summary>
    ...
    public class ReportDescriptor
    {
        ...
        /// <summary>
        /// Creates an <see cref="HidSharper.Reports.Input.HidDeviceInputReceiver"/> appropriate
        /// for receiving reports from this device.
        /// </summary>
        /// <returns>The new <see cref="HidSharper.Reports.Input.HidDeviceInputReceiver"/>.</returns>
        /// <remarks>
        /// Pair this with a <see cref="HidSharper.Reports.Input.DeviceItemInputParser"/> for your chosen <see cref="DeviceItem"/>.
        /// </remarks>
