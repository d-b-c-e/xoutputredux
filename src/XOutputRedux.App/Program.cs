...
public class Program
{
    ...
    {
        var rootCommand = new RootCommand("XOutputRedux - Xbox Controller Emulator");
    ...
    private static int SendStartCommand(string? profileName)
    {
        ...
        if (string.IsNullOrEmpty(profileName))
        {
            ...
            if (defaultProfile == null)
            {
                ...
                Console.Error.WriteLine("Either specify a profile name: XOutputRedux start \"ProfileName\"");
        ...
        if (!IpcService.IsAnotherInstanceRunning())
        {
            ...
            Console.WriteLine($"Launching XOutputRedux with profile: {profileName}");
            FreeConsole();
    ...
    private static int SendStopCommand()
    {
        if (!IpcService.IsAnotherInstanceRunning())
        {
            Console.Error.WriteLine("Error: No running instance of XOutputRedux found.");
    ...
    private static int GetStatus(bool asJson)
    {
        if (!IpcService.IsAnotherInstanceRunning())
        {
            ...
            {
                Console.WriteLine("XOutputRedux is not running.");
            }
            return ExitNoRunningInstance;
        }
        ...
        {
            Console.WriteLine("XOutputRedux Status:");
    ...
    {
        Console.WriteLine(@"XOutputRedux - Xbox Controller Emulator
========================================
...
EXAMPLES:
  ...
  XOutputRedux set-default ""My Wheel""

  # Start the default profile
  XOutputRedux start

  # Start a specific profile
  XOutputRedux start ""My Wheel""
...
For more information, visit: https://github.com/d-b-c-e/XOutputRedux
");
    }
}
