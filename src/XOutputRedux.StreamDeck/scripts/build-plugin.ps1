# Build and package XOutputRedux Stream Deck plugin
param(
    [switch]$Install,
    [switch]$SkipBuild
)
...
$pluginName = "com.xoutputredux.sdPlugin"
...
Write-Host ""
Write-Host "XOutputRedux Stream Deck Plugin Builder" -ForegroundColor Cyan
...
$pluginFile = Join-Path $outputDir "com.xoutputredux.streamDeckPlugin"
if (Test-Path $pluginFile) {
    Remove-Item $pluginFile
}

# Create zip
$zipFile = Join-Path $outputDir "com.xoutputredux.zip"
